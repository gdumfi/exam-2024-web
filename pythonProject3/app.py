...
from config import db, migrate, login_manager, Config
...
def register():
    ...
    if form.validate_on_submit():
        ...
        new_user = User(username=form.username.data, password=hashed_password, last_name=form.last_name.data, first_name=form.first_name.data, middle_name=form.middle_name.data)
